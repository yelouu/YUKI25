...
if (inputField) { // Проверяем, существует ли элемент с id "myInput"
...
if (imageStack) { // Проверяем, существует ли элемент с классом "image-stack"
    imageStack.addEventListener('click', function() {
        ...
        if (topImage) {
            ...
            setTimeout(() => {
                ...
                if (images.length > 0) {
                    // Find the new first image after the move
